...
function index()
	...
	entry({"admin", "services", "phtunnel", "status"}, template("oray/phtunnel_status"), _("Status"), 2).leaf = true
     ...
     entry({"admin", "services", "phtunnel", "inner_status"}, template("oray/phtunnel_inner_status"), _("inner_status"), 4).leaf = true
     entry({"admin", "services", "phtunnel", "log_off"}, template("oray/phtunnel_log_off"), _("log_off"), 5).leaf = true
